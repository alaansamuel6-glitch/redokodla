...
def ban_user(message):
    if message.reply_to_message:
        ...
        bot.reply_to(message, "Ответьте на сообщение пользователя командой /ban")
...
def unban_user(message):
    if message.reply_to_message:
        ...
        bot.reply_to(message, "Ответьте на сообщение пользователя командой /unban")  # ТЕПЕРЬ ОТВЕЧАЕТ!
